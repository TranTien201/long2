...
<main>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item" style="background-color: #000;">
                                <a class="nav-link active" aria-current="page" href="/contact"  style="color: #fff">Contact</a>
                            </li>
    ...
    <section class="d-flex justify-content-center mt-3">
        <div style="width: 95%;">
            <div>
                <h1>Contact Us</h1>
                <p>If you have bussiness inquiries or other question, please fill out the following form to contact
                    us. Thank you</p>
                ...
                <form class="mt-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Body<span
                                style="color: red">*</span></label>
